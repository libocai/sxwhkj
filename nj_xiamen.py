...
def sendRequest(url, year, page_index, token, cookie, province, retry_times):
    ...
    headers = {
        ...
        "Referer": "http://112.48.134.19:2021/pub/GongShiSearch",
...
try:
    ...
    for province in provinces:
        if province['name'] == '福建厦门':
            url = province['url']
            province_name = province['name']
            get_province_details_by_requests(url, province_name, '2021', '1', '40')
            get_province_details_by_requests(url, province_name, '2022', '1', '109')
            get_province_details_by_requests(url, province_name, '2023', '1', '69')
            get_province_details_by_requests(url, province_name, '2024', '1', '70')
            get_province_details_by_requests(url, province_name, '2025', '1', '9')
