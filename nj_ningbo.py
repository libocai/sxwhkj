...
try:
    ...
    for province in provinces:
        if province['name'] == '浙江宁波':
            url = province['url']
            province_name = province['name']
            get_province_details_by_requests(url, province_name, '2021', '1', '209')
            get_province_details_by_requests(url, province_name, '2022', '1', '286')
            get_province_details_by_requests(url, province_name, '2023', '1', '152')
            get_province_details_by_requests(url, province_name, '2024', '1', '287')
            get_province_details_by_requests(url, province_name, '2025', '1', '17')
