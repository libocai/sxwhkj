...
def sendRequest(url, year, page_index, token, cookie, province, retry_times):
    ...
    headers = {
        ...
        "Referer": "http://139.215.206.99:2021/pub/gongshi?pageIndex=2&cht=0&t=10c216b8ec0e4364807790582cadbc3e",
...
try:
    ...
    for province in provinces:
        if province['name'] == '吉林省':
            ...
            get_province_details_by_requests(url, province_name, '2025', '1', '89')
