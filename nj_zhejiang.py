...
def sendRequest(url, year, page_index, token, cookie, province, retry_times):
    ...
    headers = {
        ...
        "Referer": "https://njgzyybt.zjagri.cn/",
...
try:
    ...
    for province in provinces:
        if province['name'] == '浙江省':
            url = province['url']
            province_name = province['name']
            # get_province_details_by_requests(url, province_name, '2022', '1', '4352')
            get_province_details_by_requests(url, province_name, '2023', '1', '3207')
            get_province_details_by_requests(url, province_name, '2024', '1', '3439')
            get_province_details_by_requests(url, province_name, '2025', '1', '296')
