...
def sendRequest(url, year, page_index, token, cookie, province, retry_times):
    ...
    headers = {
        ...
        "Referer": "http://61.243.4.123:2021/pub/GongShiSearch",
...
try:
    ...
    for province in provinces:
        if province['name'] == '贵州省':
            url = province['url']
            province_name = province['name']
            # get_province_details_by_requests(url, province_name, '2021', '1', '1471')
            # get_province_details_by_requests(url, province_name, '2022', '1', '2248')
            get_province_details_by_requests(url, province_name, '2023', '2145', '2289')
            get_province_details_by_requests(url, province_name, '2024', '1', '2963')
            get_province_details_by_requests(url, province_name, '2025', '1', '2168')
