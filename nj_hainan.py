...
def sendRequest(url, year, page_index, token, cookie, province, retry_times):
    ...
    headers = {
        ...
        "Referer": "http://218.77.183.70:2018/",
...
try:
    ...
    for province in provinces:
        if province['name'] == '海南省':
            url = province['url']
            province_name = province['name']
            get_province_details_by_requests(url, province_name, '2021', '1', '133')
            get_province_details_by_requests(url, province_name, '2022', '1', '198')
            get_province_details_by_requests(url, province_name, '2023', '1', '184')
            get_province_details_by_requests(url, province_name, '2024', '1', '210')
            get_province_details_by_requests(url, province_name, '2025', '1', '61')
