...
def sendRequest(url, year, page_index, token, cookie, province, retry_times):
    ...
    headers = {
        ...
        "Referer": "http://221.13.83.46:1802/pub/GongShiSearch",
...
try:
    ...
    for province in provinces:
        if province['name'] == '西藏自治区':
            url = province['url']
            province_name = province['name']
            get_province_details_by_requests(url, province_name, '2021', '1', '1699')
            get_province_details_by_requests(url, province_name, '2022', '1', '1159')
            get_province_details_by_requests(url, province_name, '2023', '1', '2286')
            get_province_details_by_requests(url, province_name, '2024', '1', '2311')
            get_province_details_by_requests(url, province_name, '2025', '1', '181')
