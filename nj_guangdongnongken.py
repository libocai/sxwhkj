...
def sendRequest(url, year, page_index, token, cookie, province, retry_times):
    ...
    headers = {
        ...
        "Referer": "http://219.135.137.67:2021/",
...
try:
    ...
    for province in provinces:
        if province['name'] == '广东省农垦总局':
            url = province['url']
            province_name = province['name']
            get_province_details_by_requests(url, province_name, '2021', '1', '6')
            get_province_details_by_requests(url, province_name, '2022', '1', '2')
            get_province_details_by_requests(url, province_name, '2023', '1', '2')
            get_province_details_by_requests(url, province_name, '2024', '1', '4')
