...
def sendRequest(url, year, page_index, token, cookie, province, retry_times):
    ...
    headers = {
        ...
        "Referer": "http://124.93.228.165:2021//pub/gongshi",
...
try:
    ...
    for province in provinces:
        if province['name'] == '辽宁大连':
            url = province['url']
            province_name = province['name']
            get_province_details_by_requests(url, province_name, '2021', '1', '14')
            get_province_details_by_requests(url, province_name, '2022', '1', '90')
            get_province_details_by_requests(url, province_name, '2023', '1', '373')
