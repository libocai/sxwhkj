...
def sendRequest(url, year, page_index, token, cookie, province, retry_times):
    ...
    headers = {
        ...
        "Referer": "http://221.7.197.135:2021/pub/gongshi?pageIndex=2&cht=0&t=10c216b8ec0e4364807790582cadbc3e",
...
try:
    ...
    for province in provinces:
        if province['name'] == '广西壮族自治区':
            url = province['url']
            province_name = province['name']
            # get_province_details_by_requests(url, province_name, '2021', '1', '3974')
            get_province_details_by_requests(url, province_name, '2022', '1', '4837')
            get_province_details_by_requests(url, province_name, '2023', '1', '3468')
            get_province_details_by_requests(url, province_name, '2024', '1', '3696')
            get_province_details_by_requests(url, province_name, '2025', '1', '86')
