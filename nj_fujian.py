...
def sendRequest(url, year, page_index, token, cookie, province, retry_times):
    ...
    headers = {
        ...
        "Referer": "http://220.160.52.171:2022/GouZBT_2021To23/pub/gongshi",
...
try:
    ...
    for province in provinces:
        if province['name'] == '福建省':
            url = province['url']
            province_name = province['name']
            get_province_details_by_requests(url, province_name, '2024', '1', '4226')
            get_province_details_by_requests(url, province_name, '2025', '1', '864')
