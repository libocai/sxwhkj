...
def sendRequest(url, year, page_index, token, cookie, province, retry_times):
    ...
    headers = {
        ...
        "Referer": "http://210.76.75.39:2018/",
...
try:
    ...
    for province in provinces:
        if province['name'] == '广东省':
            ...
            get_province_details_by_requests(url, province_name, '2023', '1', '2768')
            get_province_details_by_requests(url, province_name, '2024', '1', '2086')
            get_province_details_by_requests(url, province_name, '2025', '1', '359')
