...
def sendRequest(url, year, page_index, token, cookie, province, retry_times):
    ...
    headers = {
        ...
        "Referer": "http://59.55.120.136:2018/",
...
try:
    ...
    for province in provinces:
        if province['name'] == '江西省':
            url = province['url']
            province_name = province['name']
            # get_province_details_by_requests(url, province_name, '2022', '1', '4453')
            get_province_details_by_requests(url, province_name, '2023', '1', '3816')
            get_province_details_by_requests(url, province_name, '2024', '1', '4822')
            get_province_details_by_requests(url, province_name, '2025', '1', '400')
